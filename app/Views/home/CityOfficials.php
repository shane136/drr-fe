     ...
     <hr class="mt-0 mb-6">
      ...
      <div class="box">
          <div class="box-header">
              ...
              <button class="btn btn-success mb-2" type="submit" data-bs-toggle="modal" data-bs-target="#Add">
                <iconify-icon inline icon="material-symbols:add-circle-rounded" flip="horizontal"></iconify-icon> ADD USER
              </button>
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_official" enctype="multipart/form-data">
              ...
              <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="/add_official">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          <h3 class="modal-title">Add New City Official</h3>
                            <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button> -->
                          </div>
                          <div class="modal-body">
                          <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
						                      <label>Department/Offices</label>
						                      <select class="form-select w-100" name="deptId">
                                    <option hidden></option>
                                    <?php 
                                      foreach($departments as $deparment){
                                        $deptId = $deparment->ID;
                                        $deptName = $deparment->NAME;
                                    ?>

                                    <option class="py-5 fs-5" value="<?php echo $deptId;?>"><?php echo $deptName;?></option>
            ...
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php 
                          foreach($officials as $official){
                            ...
                            $dept_name = $official->DEPARTMENT_NAME;
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $official->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>
                        
                        <a href="delete_official/<?php echo $official->ID;?> " 
              ...
              <!--EDIT USER -->
                <div class="modal fade" id="Edit<?php echo $official->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_official/<?php echo $official->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              <div class="form-group " style="width:140%; height:120%;">
                              <div class="form-group">
                              <label for="department">Department/Offices</label>
                                <select name="DEPARTMENT_ID" id="department" class="form-select">
                                  <option value="" hidden>Select Department</option>
                                    <?php foreach ($departments as $department): ?>
                                  <option value="<?= $department->ID ?>" <?= $department->ID == $official->DEPARTMENT_ID ? 'selected' : '' ?>>
                                    <?= $department->NAME ?>
                                  </option>
                                    <?php endforeach; ?>
                                </select>
                              ...
                              <div class="form-group">
						                      <label>Name</label>
						                      <input type="text" name="name" class="form-control" value="<?php echo $official->NAME;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Address</label>
						                      <input type="text" name="address" class="form-control" value="<?php echo $official->ADDRESS;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Contact Number</label>
						                      <input type="text" name="contactNumber" class="form-control" value="<?php echo $official->NUMBER;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Email Address</label>
						                      <input type="text" name="emailAddress" class="form-control" value="<?php echo $official->EMAIL_ADDRESS;?>" required>
                              </div>
                              </div>
                              </div>
                          </div>
