...
<html lang="en" dir="ltr">
  <head>
  <meta charset="UTF-8">
  <title>ADMIN | Government Offices</title>
          ...
          <div class="box-header">
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_office" enctype="multipart/form-data">
            ...
            <!--ADD USER -->
              <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="/add_office">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          <h3 class="modal-title">Add New Office</h3>
                            <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button> -->
                          </div>
                          <div class="modal-body">
                          <div class="col-md-10">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
                                    ...
                                    <select class="form-select w-100" name="officeId">
                                      <option hidden></option>
                                        ...
                                        ?>
                                               <option class="py-5 fs-5" value="<?php echo $officeId;?>"><?php echo $officeName;?></option>
                                        <?php 
                                         }
                                        ?>
                                    </select>
          ...
          <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $data->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>

                        <a href="delete_office/<?php echo $data->ID;?> " 
              ...
              <!--EDIT USER -->
                <div class="modal fade" id="Edit<?php echo $data->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_office/<?php echo $data->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
                                  ...
                                  <select name="OFFICE_ID" id="office" class="form-select">
                                      ...
                                      <?php foreach ($offices as $office) {?>
                                          <option value="<?= $office_id ?>" <?= $office->ID == $office_id ? 'selected' : '' ?>>
                                              <?= $office->NAME ?>
                                          </option>
                                      <?php } ?>
                                  </select>
                              ...
                              <div class="form-group">
						                      <label>Head</label>
						                      <input type="text" name="head" class="form-control" value="<?php echo $data->HEAD;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Contact Number</label>
