...
<html lang="en" dir="ltr">
  <head>
  <meta charset="UTF-8">
  <title>ADMIN | Training Section</title>
          ...
          <div class="box-header">
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_training" enctype="multipart/form-data">
              ...
              <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/add_training">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          <h3 class="modal-title">Add New Training Personnel</h3>
                            <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button> -->
                          </div>
                          <div class="modal-body">
                          <div class="col-md-10">
            ...
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <td><input type="hidden" name="id" value="<?php echo $training->ID; ?>"></td>
                        <td><?php echo $name; ?></td>
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $training->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>

                        <a href="delete_training/<?php echo $training->ID;?> " 
              ...
              <!--EDIT USER -->
                <div class="modal fade" id="Edit<?php echo $training->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_training/<?php echo $training->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
						                      <label>Complete Name</label>
						                      <input type="text" class="form-control" name="name" value="<?php echo $training->NAME;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Contact Number</label>
						                      <input type="text" class="form-control" name="contact" value="<?php echo $training->CONTACT;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Address</label>
						                      <input type="text" class="form-control" name="address" value="<?php echo $training->ADDRESS;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Position</label>
						                      <input type="text" class="form-control" name="pos" value="<?php echo $training->POSITION;?>" required>
                              </div>
                              </div>
                          </div>
                          <div style="clear:both;"></div>
