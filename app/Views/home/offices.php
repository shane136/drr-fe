...
<html lang="en" dir="ltr">
  <head>
  <meta charset="UTF-8">
  <title>ADMIN | Add Office(s)</title>
          ...
          <div class="box-header">
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_offices" enctype="multipart/form-data">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          <h3 class="modal-title">Batch Add Offices</h3>
                            <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button> -->
                          </div>
                          <div class="modal-body">
                          <div class="col-md-10">
                              <label for="exampleInputEmail1" class="form-label fs-6 px-2 mt-2 text-danger">Upload a file.</label>
                          </div>
                          <div class="col-md-8">
                            <div class="form-group mb-3 w-100 mt-3">
                                <div class="mb-3">
                                    <input type="file" name="file" class="form-control" id="file" accept="text/csv">
                                </div>					   
                            </div>
                          </div>
              ...
              <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="/add_offices">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
            ...
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $office->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>

                        <a href="delete_offices/<?php echo $office->ID;?> " 
            ...
            <!--EDIT-->
                <div class="modal fade" id="Edit<?php echo $office->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_offices/<?php echo $office->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
						                      <label>Office Name</label>
						                      <input type="text" class="form-control" name="name" value="<?php echo $office->NAME;?>" required>
                              </div>   
                              </div>
                          </div>
                          <div style="clear:both;"></div>
