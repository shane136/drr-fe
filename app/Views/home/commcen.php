...
<html lang="en" dir="ltr">
  <head>
  <meta charset="UTF-8">
  <title>ADMIN | Communications Center</title>
...
<div class="profile-details">
  ...
  <section class="home-section">
    <div class="home-content">
     ...
     <hr class="mt-0 mb-4">
        <h2> COMMUNICATION CENTER SECTION </h2>
      <div class="box">
          <div class="box-header">
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_commcen" enctype="multipart/form-data">
              ...
              <div class="modal fade" id="Edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="/add_commcen">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
          ...
          <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php 
                        foreach($comms as $commcen){
                          $name = $commcen->NAME;
                          $contact = $commcen->CONTACT;
                          $address = $commcen->ADDRESS;
                          $pos = $commcen->POSITION;
                        ?>
                        	
                        <tr>

                        <td><input type="hidden" name="id" value="<?php echo $commcen->ID; ?>"></td>
                        <td><?php echo $name; ?></td>
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $commcen->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>

                        <a href="delete_commcen/<?php echo $commcen->ID;?> " 
              ...
              <!--EDIT USER -->
                <div class="modal fade" id="Edit<?php echo $commcen->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_commcen/<?php echo $commcen->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
						                      <label>Complete Name</label>
						                      <input type="text" class="form-control" name="name" value="<?php echo $commcen->NAME;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Contact Number</label>
						                      <input type="text" class="form-control" name="contact" value="<?php echo $commcen->CONTACT;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Address</label>
						                      <input type="text" class="form-control" name="address" value="<?php echo $commcen->ADDRESS;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Position</label>
						                      <input type="text" class="form-control" name="pos" value="<?php echo $commcen->POSITION;?>" required>
                              </div>
                              </div>
                          </div>
                          <div style="clear:both;"></div>
