          ...
          <div class="box-header">
              ...
              <div class="modal fade" id="batchAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      ...
                      <form method="post" action="/batch_add_brgy" enctype="multipart/form-data">
              ...
              <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="/add_brgy">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          <h3 class="modal-title">Add New Barangay Official</h3>
                            <!-- <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button> -->
                          </div>
                          <div class="modal-body">
                          <div class="col-md-10">
            ...
            <div class="card-body">
                <div class="table-responsive-sm">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <a type="submit" data-bs-toggle="modal" data-bs-target="#Edit<?php echo $barangay->ID;?>" 
                            class="btn btn-warning btn-sm mb-1 w-75 align-self-center">
                              <i class="fa fa-pencil"></i>  <span> Edit</span>  
                        </a>

                        <a href="delete_brgy/<?php echo $barangay->ID;?> " 
                            class="btn btn-danger btn-sm w-75 align-self-center"
                              onclick="return confirm('Are you sure you want to delete this data?');"> 
                              <i class="fa fa-minus-circle"></i>  <span> Delete</span>           
                        </a>
            <!--EDIT USER -->
                <div class="modal fade" id="Edit<?php echo $barangay->ID;?>" tabindex="-1" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog">
                      <div class="modal-content">
                      <form method="post" action="update_brgy/<?php echo $barangay->ID;?>">
                          <div class="modal-header" style="justify-content: center; font-weight:bolder;">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="form-group">
						                      <label>Barangay</label>
						                      <input type="text" class="form-control" name="brgy" value="<?php echo $barangay->BRGY;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Name</label>
						                      <input type="text" class="form-control" name="name" value="<?php echo $barangay->NAME;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Contact Number</label>
						                      <input type="text" class="form-control" name="cnum" value="<?php echo $barangay->CONTACT_NUMBER;?>" required>
                              </div>
                              <div class="form-group">
						                      <label>Email Address</label>
						                      <input type="text" class="form-control" name="emailAddress" value="<?php echo $barangay->EMAIL_ADD;?>" required>
                              </div>
                              </div>
                          </div>
                          <div style="clear:both;"></div>
